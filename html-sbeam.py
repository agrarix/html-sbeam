...
def main():
    ...
    html.append("        Chart.defaults.font.size = 18;")
    html.append("    }")
    ...
    html.append("                    labels: {")
    html.append("                        boxWidth: 25,")
    html.append("                        padding: 3,")
    html.append("                        font: { size: 11 }")
    html.append("                    },")
    ...
    html.append("        selectYear.addEventListener('change', () => {")
    html.append("            const curM = selectMonth.value;")
    html.append("            const curD = selectDay.value;")
    html.append("            updateMonths(curM, curD);")
    html.append("        });")
    html.append("        selectMonth.addEventListener('change', () => {")
    html.append("            const curD = selectDay.value;")
    html.append("            updateDays(curD);")
    html.append("        });")
